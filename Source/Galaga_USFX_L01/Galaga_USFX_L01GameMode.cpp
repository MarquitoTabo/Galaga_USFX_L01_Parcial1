...
void AGalaga_USFX_L01GameMode::BeginPlay()
{
	...
	FVector ubicacionInicioNavesEnemigasCaza = FVector(-1700.0f, -550.0f, 250.0f);
	FVector ubicacionInicioNavesEnemigasTransporte = FVector(-1400.0f, -300.0f, 250.0f);
	...
	{
		for (int i = 0; i < 5; i++) {
			FVector PosicionNaveActual = FVector(ubicacionInicioNavesEnemigasCaza.X, ubicacionInicioNavesEnemigasCaza.Y + i * 500, ubicacionInicioNavesEnemigasCaza.Z);
		...
		for (int j = 0; j < 5; j++) {
			FVector PosicionNaveActual = FVector(nuevaposicionX, ubicacionInicioNavesEnemigasTransporte.Y + j * 500, ubicacionInicioNavesEnemigasTransporte.Z);
