...
//void AGalaga_USFX_L01Projectile::FireInDirection(const FVector& ShootDirection)
//{
//	velocidad = ShootDirection * velocidadProyectil;
//}
//
void AGalaga_USFX_L01Projectile::Tick(float DeltaTime)
{
